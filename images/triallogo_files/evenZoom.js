...
(function( $ ) {
    ...
    function EvenZoom( $container, options ) {
        ...
        this.calculateBackgroundPosition = function() {
            var backgroundPosX = ((this.currentLensPositionX - this.$container.offset().left + this.lensWidthHalf) * this.imgWidthRatio) * (-1.7) + this.lensWidthHalf;
            var backgroundPosY = ((this.currentLensPositionY - this.$container.offset().top + this.lensHeightHalf) * this.imgHeightRatio) * (-1.7) + this.lensHeightHalf;
